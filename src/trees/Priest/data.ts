  ...
  Discipline: {
    ...
    talents: {
      ...
      "Pilgrimage": {
        ...
        maxRank: 5, 
        reqPoints: 0, 
        description: talentText`Increases your chance to resist Charm and Fear effects by an additional ${[
          5,
          10,
          15,
          20,
          25,
        ]}% and increases movement and mounted speed by ${[
          2,
          4,
          6,
          8,
      ...
      "Improved Dispel Magic": {
        name: "Improved Dispel Magic", 
        pos: "c1",
        icon: icons["placeholder_icon"],
        maxRank: 2,
        reqPoints: 10,
        description: talentText`Reduces the mana cost of Dispel Magic by ${[
          10,
          20,
        ]}% and lowers the global cooldown by ${[
          0.25,
          0.5,
        ]} seconds.`,
      },
  ...
  Holy: {
    ...
    talents: {
      ...
      "Holy Link": {
        ...
        maxRank: 1, 
        reqPoints: 30, 
        description: talentText`Links the priest to a friendly target for 30 seconds. Increasing your healing done to the target by 50% and your movement speed by 30%. While linked, 50% of damage taken is redirected to the linked target. In addtion, 20% of all healing received by either the priest or the linked target is also healed on the other.`,
      },
    }
  },
  Shadow: {
    ...
    talents: {
      ...
      "Vampiric Embrace": {
        ...
        maxRank: 1, 
        reqPoints: 20, 
        description: talentText`Afflicts your target with Shadow energy that causes all party members to be healed for 10% of any Shadow spell damage you deal for 60 seconds.`, 
      },
      "Mind Overlord": {
        name: "Mind Overlord", 
        pos: "f1", 
      ...
      "Insanity": {
        ...
        maxRank: 1, 
        reqPoints: 30, 
        description: talentText`Forces a humanoid target to attack nearby units.`, 
      },
      "Shadowform": {
        name: "Shadowform", 
        pos: "g2", 
