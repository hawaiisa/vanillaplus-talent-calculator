    ...
    talents: {
      ...
      "Static Field": {
        ...
        description: talentText`Gives your damage spells a ${[
          ...
          80,
          100,
        ]}% chance to energize you, increasing damage and reducing Mana cost of your damage spells by 1% for 20 seconds. Stacks up to 10 times.`, 
      },
      "Earthquake": {
        name: "Earthquake", 
        pos: "g2", 
  ...
  Enhancement: {
    ...
    talents: {
      ...
      "Anticipation": {
        ...
        maxRank: 3, 
        reqPoints: 20, 
        description: talentText`Reduces the chance your Shock spells are resisted and the chance you are hit by spells and ranged attacks by ${[
          3,
          6,
          9,
        ]}%.`, 
      ...
      "Shamanism": {
        ...
        maxRank: 5, 
        reqPoints: 25, 
        description: talentText`Gives your Main Hand attacks a chance to enter a Shamanic Trance. The Shamanic Trance reduces the cast time and Mana cost of your next damage spell by 100% and greatly reduces target's chance to resist that spell. ${[
          "", 
