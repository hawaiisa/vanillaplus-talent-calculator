  ...
  Affliction: {
    ...
    talents: {
      ...
      "Dread": {
        ...
        maxRank: 5,
        reqPoints: 5,
        description: talentText`Reduces the casting time of Fear and Howl of Terror by ${[
          0.2,
          0.4,
          0.6,
          0.8,
          ...
          60,
          75,
        ]}% chance to avoid interruption caused by damage while casting Fear and Howl of Terror. In addition, increases the duration of Death Coil by ${[
          0.2,
          0.4,
          0.6,
          0.8,
      ...
      "Improved Drain": {
        ...
        description: talentText`Increases the Health drained by your Drain Life and Drain Soul spells by ${[
          ...
          15,
          30,
        ]}% of the Mana drained by your Drain Mana and Drain Soul spells to damage the opponent. In addition, increases the drain-to-damage conversion to ${[
          25,
          50,
        ]}%.`,
      },
      ...
      "Death and Decay": {
        ...
        description: talentText`Invokes the malignant power of death and decay, reducing the effectiveness of any healing by 20% and inflicting Shadow damage equal to your level to nearby enemies every 2 seconds for 30 sec.`,
      },
      "Shadow Mastery": {
        name: "Shadow Mastery",
        pos: "f1",
      ...
      "Withering Shroud": {
        name: "Withering Shroud",
        pos: "e3",
        icon: icons["spell_shadow_callofbone"],
        maxRank: 2,
        reqPoints: 20,
        description: talentText`Afflicts nearby enemies with a disease that causes Shadow damage equal to ${[
          100,
          200,
  ...
  Demonology: {
    ...
    talents: {
      ...
      "Demonic Embrace": {
        ...
        maxRank: 5,
        reqPoints: 5,
        description: talentText`The warlock regenerates ${[
          0.2,
          0.4,
          0.6,
          0.8,
          1,
        ]}% health every 2 seconds. In addition, increases the effect of Demon Armor and Demon Skin by ${[
          10,
          20,
          30,
          40,
  ...
  Destruction: {
    ...
    talents: {
      ...
      "Shock and Awe": {
        ...
        maxRank: 1, 
        reqPoints: 30, 
        description: talentText`Stuns the target for 4 seconds. While stunned, the target receives an additional 15% damage from all sources and cannot be healed.`, 
      },
      "Improved Immolate": {
        ...
        maxRank: 1, 
        reqPoints: 30, 
        description: talentText`Allows your immolate to stack up to 2 times.`,
      },
    },
  },
};
