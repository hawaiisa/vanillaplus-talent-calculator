    ...
    talents: {
      ...
      "Improved Aspect of the Hawk": {
        ...
        description: talentText`While Aspect of the Hawk is active, gives you a ${[
          ...
          40,
          50,
        ]}% chance of increasing ranged attack speed by 30% for 5 seconds after dealing a critical strike with a ranged attack.`, 
      },
      "Endurance Training": {
      ...
      "Kill Command": {
        ...
        description: talentText`Give the command to kill, increasing the damage done by yout pet by 100% for 5 seconds. Only usable against enemies that have 20% or less health.`, 
      },
      "Terrifying Roar": {
        ...
        maxRank: 1, 
        reqPoints: 30,
        description: talentText`Roars at an enemy, paralyzing it with terror for 6 seconds. In addition, up to 5 total nearby enemies will flee in fear for 12 seconds.`, 
      },
    },
  },
  Marksmanship: {
    ...
    talents: {
      ...
      /* CHANGED 5/10 seconds to 10/10 BECAUSE UNSURE FROM CHANGELOG -> CAN BE REMOVED LATER*/
      "Stalking": {
        name: "Stalking", 
        pos: "b1", 
        ...
        description: talentText`After killing an opponent that yields experience or honor, your critical strike chance is increased by ${[
          10,
          10,
        ]}% and the amount of threat generated is reduced by 99% for ${[
          10,
          20,
        ]} seconds. In addition, reduces the cooldown of your Rapid Fire and Rapid Strikes by ${[
          1,
          2,
        ]} min.`, 
      },
      ...
      "Falcon Strikes": {
        ...
        maxRank: 3, 
        reqPoints: 10,
        description: talentText`Direct attacks deal ${[
          1,
          2,
          3,
        ]}% increased damage for every 6 yards of elevation advantage.`,      
      },
      "Mortal Shots": {
        name: "Mortal Shots", 
        pos: "c3", 
      ...
      "Hawk Eye": {
        ...
        maxRank: 1, 
        reqPoints: 10,
        description: talentText`Increases the range of your ranged weapons by 6 yards.`,
      },
      "Snapshot": {
        name: "Snapshot", 
        pos: "d1", 
      ...
      "Scatter Shot": {
        ...
        maxRank: 1, 
        reqPoints: 20,
        description: talentText`A short-range shot that deals damage and disorients the raget for 4 seconds. Any damage caused will remove the effect. Turns off your attack when used.`, 
      },
      "Deadeye": {
        name: "Deadeye", 
        pos: "e4", 
  ...
  Survival: {
    ...
    talents: {
      ...
      "Savage Strikes": {
        ...
        maxRank: 5, 
        reqPoints: 5, 
        description: talentText`Increases critical strike chance of Raptor Strike and Mongoose Bite by ${[
          3,
          6,
          9,
          12,
      ...
      "Melee Specialization": {
        ...
        maxRank: 1, 
        reqPoints: 10,
        description: talentText`Increases your melee attack speed by 30%, but reduces your ranged attack speed by 20% and increases the shot time of your Aimed Shot and Multi-Shot by 1 sec.`, 
      },
      ...
      "Killer Instinct": {
        ...
        maxRank: 5, 
        reqPoints: 10,
        description: talentText`Increases hit and crit chance by ${[
          1,
          2,
          3,
          4,
      ...
      "Find Weakness": {
        ...
        description: talentText`Your ranged critical strikes have a ${[
          ...
          80,
          100,
        ]}% chance to reveal a flaw in your target\'s defenses, increasing the critical strike chance of attacks made against that target by an additional 5% for 20 seconds.`, 
      },
      "Lightning Reflexes": {
      ...
      "Whirling Axe": {
        ...
        maxRank: 1, 
        reqPoints: 30,
        description: talentText`Hurls an axe at a target, causing damage equal to 10% of your melee attack power and slowing the target's movement speed by 60% for 10 seconds. This attack always crits. It also interrupts spellcasting and prevents any spell in that school from being cast for 5 seconds.`, 
      },
    },
  },
};
